(define (problem taquin-resolu)
  (:domain taquin)
  (:objects 
    t2 t3 t4 t5 t6 t7 t8 t9 t10 t11 t12 t13 t14 t15 t16 - tile
    p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13 p14 p15 p16 - position
  )

  (:init
    (at t2 p2)  (at t3 p3)  (at t4 p4)
    (at t5 p5)  (at t6 p6)  (at t7 p7)  (at t8 p8)
    (at t9 p9)  (at t10 p10)  (at t11 p11)  (at t12 p12)
    (at t13 p13)  (at t14 p14)  (at t15 p15) (at t16 p16)
    (empty p1)
  ...
  (:goal (and
    (at t16 p16)  (at t2 p2)  (at t3 p3)  (at t4 p4)
    (at t5 p5)  (at t6 p6)  (at t7 p7)  (at t8 p8)
    (at t9 p9)  (at t10 p10)  (at t11 p11)  (at t12 p12)
